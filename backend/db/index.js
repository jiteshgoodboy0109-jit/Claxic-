...
export const initialData = {
  ...
  applications: [
    {
      id: 'app_sample_001',
      applicationNumber: 'CLX-2026-8812',
      userId: 'usr_student_001',
      userEmail: 'alex.morgan@stanford.edu',
      ...
      formData: {
        ...
        statementOfIntent: 'Focusing my final year capstone on production LLM agents and multi-agent microservices.',
        agreedToTerms: true,
  ...
  payments: [
    {
      ...
      orderId: 'order_clx_994101',
      paymentId: 'pay_rzp_994101_live',
      userId: 'usr_student_001',
      userName: 'Alex Morgan',
      userEmail: 'alex.morgan@stanford.edu',
      courseId: 'crs_ai_fullstack_2026',
  ...
  notifications: [
    {
      ...
      message: 'Welcome to Applied GenAI & Full-Stack System Architecture. Receipt #REC-2026-9941 has been generated.',
      type: 'success',
      link: '/dashboard',
      isRead: false,
      createdAt: '2026-08-18T10:35:00.000Z'
  ...
  auditLogs: [
    {
      ...
      adminName: 'Dr. Evelyn Vance',
      action: 'SYSTEM_INITIALIZED',
      targetType: 'SYSTEM',
      targetId: 'claxic_sys_001',
      targetTitle: 'Claxic Academic Platform V2.5 Activated',
